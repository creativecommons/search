      ...
      <form onsubmit="return doSearch()">
        ...
        <div id="secondaryOptions">
          ...
          <label>
           ...
           <label>
              <div class="engineRadio">
                <input type="radio" onclick="setEngine(this)" name="engine" value="fotopedia"><br/>&nbsp;
              </div>
              <div class="engineDesc"><strong>Fotopedia</strong><br/><?php echo _('Image'); ?></div>
            </label>
          <label>
            <div class="engineRadio">
  ...
  <div class="mainContent" style="margin-top:30px">
    <div id="help">
      ...
      <div class="column wrong">
        ...
        <p><a href="http://wiki.creativecommons.org/Firefox_and_CC_Search"><?php echo _('<strong>Click here</strong></a> to find out how to change CC Search as your default search from browsers such as Firefox.'); ?></p>
      </div>
    </div>
